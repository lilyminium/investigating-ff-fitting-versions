...
for i in $(seq 1 8); do
    work_queue_worker --cores 1 -s working-directory/ --disk-threshold=0.002 --disk=3000 --memory-threshold=1000 --memory 1000 -b 20 -t 3600 "${DESTINATION}.hpc.private:32001" &
done
wait
